...
def generate_output_filename(args) -> str:
    ...
    if args.start_time is not None:
        filename_parts.append(f"start{int(args.start_time)}")

    if args.end_time is not None:
        filename_parts.append(f"end{int(args.end_time)}")
...
def main():
    ...
    if args.start_time:
        print(f"  Filter: start_time >= {args.start_time} ms")
    if args.end_time:
        print(f"  Filter: end_time <= {args.end_time} ms")
